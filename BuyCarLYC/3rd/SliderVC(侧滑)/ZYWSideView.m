...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self=[super initWithFrame:frame]) {
        ...
        //        创建透明view上的tableview
        ZYWSideTableView *sbv=[[ZYWSideTableView alloc]initWithFrame:CGRectMake(0,[UIScreen mainScreen].bounds.size.height*0.03,[UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height)];
//
